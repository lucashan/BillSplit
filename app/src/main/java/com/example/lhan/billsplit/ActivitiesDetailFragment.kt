...
class ActivitiesDetailFragment : Fragment() {
     ...
     */
    private var item: ActivitiesViewModel.HouseBill? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            if (it.containsKey(ARG_ITEM_ID)) {
                ...
                item = activitiesViewModel.ITEM_MAP[it.getString(ARG_ITEM_ID)]
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.fragment_activities_detail, container, false)

        // Show the dummy content as text in a TextView.
        item?.let {
            rootView.user_detail.text = it.user
            rootView.content_detail.text = it.content
            rootView.price_detail.text = it.price
        }
